from flask import Flask, request, jsonify, send_file
  ...
  def predict():
      try:
          print("Received predict request:", request.get_json())  # Add logging
          ...
          print("Sending response:", response)  # Add logging
          return jsonify(response)
      except (KeyError, ValueError) as e:
          print("Error in predict:", str(e))  # Add logging
          return jsonify({'error': 'Invalid input data. All fields must be numbers.'}), 400
      except Exception as e:
          print("Unexpected error in predict:", str(e))  # Add logging
